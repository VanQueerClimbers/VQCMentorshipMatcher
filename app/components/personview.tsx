...
const PersonView: React.FC<ChildProps> = ( { person } ) => {
  ...
  return (
    <div>
      <div
        className="bg-purple-400 border-2 border-purple-900 border-solid rounded-lg flex text-sm m-1 divide-purple-900 divide-x divide-solid hover:bg-purple-600 hover:cursor-pointer hover:text-white"
